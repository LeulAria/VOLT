...
import { ACTIVITY_BAR_BACKGROUND, ACTIVITY_BAR_BORDER, ACTIVITY_BAR_FOREGROUND, ACTIVITY_BAR_ACTIVE_BORDER, ACTIVITY_BAR_BADGE_BACKGROUND, ACTIVITY_BAR_BADGE_FOREGROUND, ACTIVITY_BAR_INACTIVE_FOREGROUND, ACTIVITY_BAR_ACTIVE_BACKGROUND, ACTIVITY_BAR_DRAG_AND_DROP_BORDER, ACTIVITY_BAR_ACTIVE_FOCUS_BORDER, TITLE_BAR_ACTIVE_BACKGROUND } from '../../../common/theme.js';
...
export class ActivitybarPart extends Part {
	...
	static readonly ACTION_HEIGHT = 36;
	...
	override updateStyles(): void {
		...
		const agentSurface = this.layoutService.getSideBarPosition() === Position.RIGHT
			|| this.layoutService.mainContainer.classList.contains('volt-layout-agent');
		const agentLayout = this.layoutService.mainContainer.classList.contains('volt-layout-agent');
		const background = agentLayout ? '' : (this.getColor(agentSurface ? TITLE_BAR_ACTIVE_BACKGROUND : ACTIVITY_BAR_BACKGROUND) || '');
